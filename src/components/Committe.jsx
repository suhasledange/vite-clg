...
const Committe = () => {
  return (
    ...
    <div className='space-y-12 border bg-white p-5 shadow'>
        ...
        <div className=''>
             <h1 className='text-xl font-medium'>COMMITTEE : </h1>  
        </div>
        ...
        <div>
          <h1 className='text-lg mb-2'>Internal Advisory Board</h1>
          <ul className='list-star'>
        ...
        <div>
          <h1 className='text-lg mb-2'>Co-Conference Chairs</h1>
          <ul className='list-star'>
              <li className='text-sm'></li>
              <li className='text-sm'></li>
              <li className='text-sm'></li>
        ...
        <div>
          <h1 className='text-lg mb-2'>Co-General Chairs</h1>
          <ul className='list-star'>
              <li className='text-sm'></li>
              <li className='text-sm'></li>
              <li className='text-sm'></li>
        ...
        <div>
          <h1 className='text-lg mb-2'>Publicity Chairs</h1>
          <ul className='list-star'>
              <li className='text-sm'></li>
              <li className='text-sm'></li>
              <li className='text-sm'></li>
